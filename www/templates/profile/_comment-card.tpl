<div class="user-comment">
	<div class="user-comment-wrap">
		<div class="comment-wrap">
			<div class="user-name"><a href="<?=HOST?>blog/post?id=<?=$comment['post_id']?>"><?=$comment['post_title']?></a></div>
			...
			<span class="user-date--dat"><?=rus_date("j F Y H:i",strtotime($comment['date_time']))?></span>
			</div>
		</div>
